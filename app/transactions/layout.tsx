      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
        <div className="max-w-screen-2xl mx-auto px-4 h-14 flex items-center gap-6">
          ...
          <nav className="flex gap-4 text-sm">
            <Link href="/dashboard" className="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition-colors">
              대시보드
            </Link>
            <Link href="/transactions" className="text-blue-600 font-medium hover:text-blue-500 transition-colors">
              거래내역
            </Link>
          </nav>
